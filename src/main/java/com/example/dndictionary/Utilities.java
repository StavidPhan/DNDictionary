...
//    public static final String APP_TITLE = "DNDictionary";
...
//            }
    ...
    public static void main(String[] args) {
        List<String> words = Utilities.loadFromTextFile("src/main/resources/com/example/dndictionary/database/anhviet109K.txt");
